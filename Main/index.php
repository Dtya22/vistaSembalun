...
<html lang="en">
  ...
  <body>
    <nav class="navbar">
        ...
        <a href="index.php" class="navbar-logo">VistaSembalun</a>
      ...
      <div class="navbar-extra">
        <div class="search-container">
          <form action="login.php" id="logoutForm" method="post">
            <button type="submit" class="logout" id="logout">Log In</button>
          </form>
        </div>
    </div>
        </div>
